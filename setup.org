...
#+HTML_LINK_HOME: http://wrigstad.com/thesis-guide/
#+HTML_LINK_UP: http://wrigstad.com/thesis-guide/
...
#+HTML_HEAD: <link rel="stylesheet" type="text/css" href="http://wrigstad.com/thesis-guide/css/htmlize.css"/>
#+HTML_HEAD: <link rel="stylesheet" type="text/css" href="http://wrigstad.com/thesis-guide/css/readtheorg.css"/>
...
#+HTML_HEAD: <script type="text/javascript" src="http://wrigstad.com/thesis-guide/js/jquery.stickytableheaders.min.js"></script>
#+HTML_HEAD: <script type="text/javascript" src="http://wrigstad.com/thesis-guide/js/readtheorg.js"></script>
