...
_Pro tip_: it is very easy at this stage to change the order of
...
_Pro tip_: Most readers do not read a text in a linearly fashion,
nor in one go. Write for those readers, not for the unicorns that
do.
...
_Pro tip:_ Use your plan to identify text that can be /cut/
